...
from ..viztools.draw import (draw_batch_joint_images, draw_batch_mesh_images_pred,
                             draw_batch_hand_mesh_images_2d, draw_batch_joint_pair_overlay_images,
...
class POEM_RLE(nn.Module, ModuleAbstract):
    ...
    def _maybe_log_stage_transition_loss(self, mode, epoch_idx, stage_name, loss_dict, pose_metric_dict=None):
        ...
        logger.warning(
            ...
            f"rle={(_to_float('loss_rle_hand') or 0.0):.4f} "
        ...
        if mode == "train":
            ...
            if self.current_stage_name == "stage1":
                ...
                return (f"{stage_short}{warmup_suffix} | "
                        f"L {l_total:.3f} | "
                        f"B T/J/P/R {l_triang:.3f}/{l_3d_jts:.3f}/{l_2d_proj:.3f}/{l_rle:.3f} | "
            ...
            return (f"{stage_short}{warmup_suffix} | "
                    f"L {l_total:.3f} | "
                    f"B T/J/R {l_triang:.3f}/{l_3d_jts:.3f}/{l_rle:.3f} | "
                    f"SVL I/D/P/S {l_obj_init:.3f}/{l_obj_view_direct:.3f}/{l_obj_view_points:.3f}/{l_obj_self:.3f} | "
